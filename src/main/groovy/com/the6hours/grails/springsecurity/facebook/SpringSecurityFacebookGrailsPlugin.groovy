...
class SpringSecurityFacebookGrailsPlugin extends Plugin {
    ...
    def title = "Grails Spring Security Facebook"
    def author = 'Igor Artamonov'
    def authorEmail = 'igor@artamonov.ru'
    def description = 'Facebook Authentication for Spring Security Core plugin'

    def profiles = ['web']

    def documentation = "http://splix.github.io/grails-spring-security-facebook/"
